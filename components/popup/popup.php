...
class EasyAzon_Components_Popup {
	...
	public static function enqueue_scripts($settings) {
		wp_enqueue_script('easyazon-knockout', plugins_url('vendor/knockout.js', EASYAZON_PLUGIN_FILE), array(), '3.2.0', true);

		wp_enqueue_script('easyazon-popup', plugins_url('resources/popup.js', __FILE__), array('jquery', 'easyazon-knockout'), EASYAZON_VERSION, true);
